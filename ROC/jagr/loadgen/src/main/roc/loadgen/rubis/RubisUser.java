/*
 * $Id: RubisUser.java,v 1.6 2004/07/28 01:53:15 candea Exp $
 */
    ...
    extends roc.loadgen.User
{
	...
	{
	    try {
		generator = new RequestGenerator( conf.workloadFile, conf.serverName );
	    }
	    catch( Exception e ) 
	    {
	...
	log.debug( "user wants next req to be " + currentRequest );
