...
### $Id: run.sh,v 1.2 2004/07/12 03:57:53 candea Exp $ ###
...
# Augment JBOSS_CLASSPATH with the jar containing Pinpoint code
JBOSS_CLASSPATH="$JBOSS_CLASSPATH:$JBOSS_HOME/lib/pinpoint.jar"
