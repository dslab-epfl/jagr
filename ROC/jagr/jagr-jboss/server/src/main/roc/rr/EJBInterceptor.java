    ...
    extends org.jboss.ejb.plugins.AbstractInterceptor
{
    ...
    // The types of actions this interceptor supports 
    public final static Object NO_ACTION        = new Object();
    public final static Object MICROREBOOT      = new Object();
    public final static Object INJECT_MEMLEAK   = new Object();
    public final static Object INJECT_THROWABLE = new Object();
    public final static Object SET_NULL_TXINT   = new Object();
    public final static Object DEADLOCK         = new Object();
    public final static Object INFINITE_LOOP    = new Object();
    public final static Object CORRUPT_DATA     = new Object();

    // Keys for passing values corresponding to actions
    public final static Object MEMLEAK_BYTES_PER_CALL = new Object();
    public final static Object THROWABLE_NAME         = new Object();
    public final static Object DEADLOCK_PARAMS        = new Object();
    public final static Object MAX_INFINITE_LOOP      = new Object();
    public final static Object FIELD_NAME             = new Object();

    // Action to take on the next intercepted invocation
    private Object Action = NO_ACTION;
	...
	throws Exception 
    {
	Action = invocation.getValue( SERVICE_ACTION );
	    
	if ( Action == NO_ACTION ) 
	{
	    Log.info( "Canceled previously scheduled actions" );
	}
	else if ( Action == MICROREBOOT )
	{
	    Log.info( "uRB scheduling not currently supported" );
	}
	else if ( Action == INJECT_MEMLEAK )
	{
	    Integer bytes = (Integer) invocation.getValue( MEMLEAK_BYTES_PER_CALL );
	    LeakNumBytes = bytes.intValue();
	    Log.info( "Scheduled memory leak for " + LeakNumBytes + " bytes/call" );
	}
	else if ( Action == INJECT_THROWABLE )
	{
	    ThrowableName =  (String) invocation.getValue( THROWABLE_NAME );
	    Log.info( "Scheduled injection of throwable " + ThrowableName );
	}
	else if ( Action == SET_NULL_TXINT )
	{
	...
	{
	    Vector v = (Vector) invocation.getValue( DEADLOCK_PARAMS );
	...
	else if ( Action == INFINITE_LOOP )
	{
	    Integer max = (Integer) invocation.getValue( MAX_INFINITE_LOOP );
	    MaxILoop = max.intValue();
	    Log.info( "Scheduled infinite loop for consecutive "+MaxILoop
		      +" calls" ); 
	}
	else if ( Action == CORRUPT_DATA ) {
	    String logMessage = null;
	    Action = NO_ACTION;
	    String fieldName = (String)invocation.getValue( FIELD_NAME );
