...
public class Msg implements java.io.Serializable {
	...
	public void MakeWriteReq(long key, Object data, int check, long exp) {
		...
		// s.kawamoto
		/*
		System.out.println("Msg type: "+_type);
		System.out.println("Msg data: "+_data);
		System.out.println("Msg chck: "+_checksum);
		System.out.println("Msg exp:  "+_exp);
		System.out.println("Msg key:  "+_key);
		*/
	}
