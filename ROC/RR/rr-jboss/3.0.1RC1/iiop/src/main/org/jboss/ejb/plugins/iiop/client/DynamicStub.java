 ...
 * the IDL name of the operation, a <code>StubStrategy</code> instance to be
 * used for marshalling parameters and unmarshalling the result, plus an array 
      ...
      extends javax.rmi.CORBA.Stub
{
   ...
   /**
    * Constructs a <code>DynamicStub</code>.
    */
   public DynamicStub()
   {
      super();
