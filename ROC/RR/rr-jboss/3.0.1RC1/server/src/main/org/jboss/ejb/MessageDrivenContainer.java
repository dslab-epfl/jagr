    ...
    implements ContainerInvokerContainer, InstancePoolContainer
{
   ...
   public void setContainerInvoker(final ContainerInvoker containerInvoker)
   {
      if (containerInvoker == null)
         throw new NullArgumentException("containerInvoker");

      this.containerInvoker = containerInvoker;
      this.containerInvoker.setContainer(this);
   }
      ...
      throws Exception
   {
      ...
      Object fMode =  super.invoke(mi);
      // Invoke through interceptors
      if(fMode != null)  return getInterceptor().invoke(mi);
      return null;    
   }
