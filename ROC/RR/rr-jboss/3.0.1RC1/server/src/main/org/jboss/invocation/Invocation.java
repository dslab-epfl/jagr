...
public class Invocation
{
   ...
   */
   ...
   public Transaction getTransaction() { return (Transaction) as_is_payload.get(TRANSACTION); }
   ...
   public Principal getPrincipal() { return (Principal) as_is_payload.get(PRINCIPAL);}
   ...
   public Object getCredential() { return getPayloadValue(CREDENTIAL); }
   
   // A container for server side association
   public void setObjectName(Object objectName) { this.objectName = objectName; }
   public Object getObjectName() { return objectName; }
   ...
   public Object getId() { return getPayloadValue(CACHE_ID);}
   ...
   public void setArguments(Object[] arguments) { args = arguments; }
   ...
   public void setInvocationContext(InvocationContext ctx) { invocationContext = ctx; }
