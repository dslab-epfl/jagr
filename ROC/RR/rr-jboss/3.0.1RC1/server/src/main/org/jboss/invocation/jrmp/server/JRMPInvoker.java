    ...
    implements Invoker, JRMPInvokerMBean,  MBeanRegistration
{
   ...
   public void postRegister(Boolean registrationDone)
   {
      ...
      {
         log.error( "Registration of JRMP Invoker MBean failed" );
      }
   }
   ...
   /** Load and instantiate the clientSocketFactory, serverSocketFactory using the TCL
   and set the bind address and SSL domain if the serverSocketFactory supports it.
   */
