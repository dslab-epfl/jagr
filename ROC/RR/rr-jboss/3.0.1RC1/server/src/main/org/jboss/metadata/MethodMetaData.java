...
public class MethodMetaData extends MetaData
{
   ...
   public static final int REMOTE_METHOD = 0;
   public static final int LOCAL_METHOD = 1;
   public static final int HOME_METHOD = 2;
   public static final int LOCAL_HOME_METHOD = 3;
   ...
   /** One of: HOME_METHOD, REMOTE_METHOD, LOCAL_HOME_METHOD, LOCAL_METHOD or ANY_METHOD
    */
   private int methodType = ANY_METHOD;
   ...
   { return methodType == HOME_METHOD ; }
   public boolean isRemoteMethod()
   { return methodType == REMOTE_METHOD ; }
   public boolean isLocalHomeMethod()
   { return methodType == LOCAL_HOME_METHOD ; }
   public boolean isLocalMethod()
   { return methodType == LOCAL_METHOD ; }
   ...
   public boolean patternMatches(String name, Class[] arg, int iface)
   {
      return patternMatches(name, getClassNames(arg), iface);
   }
   
   public boolean patternMatches(String name, String[] arg, int iface)
   {
      // the wildcard matches everything
      if (getMethodName().equals("*"))
      {
         if( methodType != ANY_METHOD && methodType != iface )
            return false;
         return true;
      }
