            ...
            AbstractPassivationJob job = new AbstractPassivationJob(bean, key)
               {
                  public void execute() throws Exception
                  {
                     ...
                     if( jobCtx == null || jobCtx.getId() == null )
                     {
                     ...
                     try
                     {
                        ...
                        synchronized (getCacheLock())
                        {
                           ...
                           synchronized (this)
                           {
                              if (jobCtx instanceof EntityEnterpriseContext)
                              {
                                 // Verify that this ctx hasn't already
                                 // been freed and re-used by another thread.
                                 EntityEnterpriseContext entityCtx = (EntityEnterpriseContext) jobCtx;
