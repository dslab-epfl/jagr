 ...
 * <p><b>Revisions:</b>
 *
 * <p><b>29.12.2001 - Sacha Labourey:</b>
 * <ul>
...
public class CMPClusteredInMemoryPersistenceManager implements org.jboss.ejb.EntityPersistenceStore
{
   ...
   public Collection findEntities (Method finderMethod, Object[] args, EntityEnterpriseContext instance) throws Exception
   {
      if (finderMethod.getName ().equals ("findAll"))
      {
         ...
         if (tmpColl == null)
            ...
            return new ArrayList (tmpColl);
      } else
      {
         // only support find all
         return Collections.EMPTY_LIST;
      }
   }
   ...
   public void loadEntity (EntityEnterpriseContext ctx)
   {
      try
      {
         ...
         new java.io.ByteArrayInputStream ((byte[])this.ds.get (this.DS_CATEGORY, ctx.getId ().toString ())));
