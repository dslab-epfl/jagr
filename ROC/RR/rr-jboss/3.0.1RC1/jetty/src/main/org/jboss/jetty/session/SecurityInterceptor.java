  ...
  extends AroundInterceptor
{
  ...
  protected final Principal _ourPrincipal;
  protected final Object    _ourCredential;

  protected ThreadLocal     _theirPrincipal=new ThreadLocal();
  protected ThreadLocal     _theirCredential=new ThreadLocal();

  public
    SecurityInterceptor(Manager ignore, HttpSession session, State state)
  {
    super(session, state);

    _ourPrincipal=null;		// retrieve from Manager
    _ourCredential=null;

    // pick up the security context from our manager...
  }
