...
public class JMX extends Task
{
   ...
   {
      void execute(RemoteMBeanServer server) throws Exception;
   }
      ...
      implements Operation
   {
      ...
      public void execute(RemoteMBeanServer server) throws Exception
      {
         ...
         server.invoke(target, operation, args, types);
      }
   }
