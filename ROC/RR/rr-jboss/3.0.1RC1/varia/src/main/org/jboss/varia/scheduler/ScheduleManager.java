...
//AS         log.info( "Start Providing on: " + lProviderName + ", based on: " + pProviderObjectName );
      ...
      // CANDEA start
         ...
         throw new RuntimeException( "<<< RR-specific (ScheduleManager.registerProvider) >>> " + e.toString() );
      }
      // CANDEA end
   }
   ...
   public void unregisterProvider( String pProviderObjectName ) {
      ...
      // CANDEA start
         ...
         throw new RuntimeException( "<<< RR-specific (ScheduleManager.unregisterProvider) >>> " + e.toString() );
      }
      // CANDEA end
      finally {
        ...
        throws Exception
   {
      ...
      if( !( (Boolean) getServer().getAttribute( mTimer, "Active" ) ).booleanValue() ) {
         ...
         getServer().invoke(
            ...
            throw new RuntimeException( "<<< RR-specific (ScheduleManager.startService) >>> " + e.toString() );
         }
         // CANDEA end
      }
   ...
   private class ScheduleInstance {
         ...
         throws JMException
      {
         ...
         mNotificationID = ( (Integer) getServer().invoke(
            ...
            throw new RuntimeException( "<<< RR-specific (ScheduleManager.start) >>> " + e.toString() );
         }
         // CANDEA end

         // Register the notification listener at the MBeanServer
         MBeanListener mListener = new MBeanListener( this );
         ...
         throws JMException
      {
         ...
         // CANDEA start
            ...
            throw new RuntimeException( "<<< RR-specific (ScheduleManager.stop) >>> " + e.toString() );
         }
         // CANDEA end
      }
