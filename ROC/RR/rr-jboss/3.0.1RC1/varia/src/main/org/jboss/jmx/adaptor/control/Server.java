...
public class Server
{
   ...
   public static Iterator getDomainData(String filter) throws JMException
   {
      ...
      HashMap domainData = new HashMap();
      if( server != null )
      {
      ...
      throws JMException
   {
      ...
      return new AttrResultInfo(attrName, editor, value);
   }
      ...
      throws JMException
   {
      ...
      Object opReturn;
      try {  // CANDEA
         opReturn = server.invoke(objName, opName, typedArgs, argTypes);
      }
      catch (Exception e) {
         throw new RuntimeException("<<< RR-specific (Server.invokeOpByName) >>> " + e.toString());
      }
