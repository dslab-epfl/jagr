   ...
   implements Referenceable, DataSource, Serializable  
{
   ...
   public LocalDataSource (final LocalManagedConnectionFactory mcf, final ConnectionManager cm)
   {
      this.mcf = mcf;
      this.cm = cm;   
   }
   ...
   {
      ConnectionRequestInfo cri = new LocalConnectionRequestInfo(user, password);
      try 
      {
