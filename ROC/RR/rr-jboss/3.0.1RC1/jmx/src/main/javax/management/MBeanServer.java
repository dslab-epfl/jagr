...
public interface MBeanServer
{
   ...
   /*---------- Start RR-specific methods ------------------------------------*/

   public void injectException( String serviceName, String operationName, String exceptionType );

   /*---------- End RR-specific methods --------------------------------------*/

   public Object invoke(ObjectName name, String operationName, Object[] params, String[] signature)
      throws InstanceNotFoundException, MBeanException, ReflectionException, Exception;
