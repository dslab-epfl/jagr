  ...
  implements RelationServiceMBean, MBeanRegistration, NotificationListener
{
           ...
           RelationServiceNotRegisteredException, RoleNotFoundException
  {
    ...
    else
    {
      ...
      {
         throw new RuntimeException("<< RR-specific (RelationService.getRole) >>> " + e.toString());
      }
      // CANDEA start
    }
  }
           ...
           RoleNotFoundException
  {
    ...
    else
    {
      ...
      {
         throw new RuntimeException("<<< RR-specific (RelationService.getRoleCardinality >>> " + e.toString());
      }
      // CANDEA end
    }
  }
           ...
           RelationServiceNotRegisteredException
  {
    ...
    else
    {
      ...
      {
         throw new RuntimeException("<<< RR-specific (RelationService.getRoles) >>> " + e.toString());
      }
      // CANDEA end
    }
  }
           ...
           RelationNotFoundException
  {
    ...
    else
    {
      ...
      {
         throw new RuntimeException("<<< RR-specific (RelationService.setRoles) >>> " + e.toString());
      }
      // CANDEA end
    }
  }
