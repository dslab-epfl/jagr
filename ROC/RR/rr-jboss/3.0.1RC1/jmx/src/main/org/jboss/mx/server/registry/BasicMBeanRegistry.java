   ...
   implements MBeanRegistry
{
   ...
   public ObjectInstance registerMBean(Object object, ObjectName name,
                                       ClassLoader cl, Object magicToken)
             ...
             NotCompliantMBeanException
   {
      ...
      try
      {
         ...
         regName = validateAndQualifyName(regName, (String)magicToken);
      ...
      catch (MBeanRegistrationException e)
      {
         ...
         // FIXME: the logs below should probably be of type WARN as an exception
         //        from within the bean's preRegister() is most likely unintentional
         //        and indicates a coding error or unsatisfied dependency, etc --
         //        debug for now since we're dumping everything on the console.... (jpl)
         log.debug("preRegister() failed " +
                  "[ObjectName='"  + name +
                  "', Class=" + object.getClass().getName() + 
                  " (" + object + ")]"
         );
