...
public class CircularityErrorTests
{
   ...
   public void testClassCircularityError() throws Exception
   {
      ...
      UnifiedLoaderRepository repository = new UnifiedLoaderRepository();
      final UnifiedLoader ucl = new UnifiedLoader(getClass().getProtectionDomain().getCodeSource().getLocation());
      ucl.setRepository(repository);
   ...
   public class UnifiedLoader extends UnifiedClassLoader
   {
