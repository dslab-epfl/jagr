...
* @version $Id: BeanUnitTestCase.java,v 1.1.1.1 2002/10/03 21:06:56 candea Exp $
*/
...
extends JBossTestCase
{
   ...
   throws Exception
   {
      ...
      getLog().debug(++test+"- "+"Get Primary Key ... " + statelessSession.getPrimaryKey());
