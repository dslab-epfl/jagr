   ...
   implements EARDeployerMBean
{
      ...
      throws DeploymentException
   {
	 ...
	 /* Tell AFPI that we are starting up this J2EE app (candea@stanford.edu) */
	 String compUID = di.url.toString();
	 String compName = compUID.replaceAll(".*/","");
	 roc.rr.afpi.Interceptor.addComponent(compUID, compName, "J2EE App");
