...
### $Id: run.sh,v 1.2 2003/11/22 07:19:23 candea Exp $ ###
...
# Augment JBOSS_CLASSPATH with the jar containing the MySQL JDBC
# driver; this is needed at startup because the AFPI monitor connects
# to MySQL upon boot
JBOSS_CLASSPATH="$JBOSS_CLASSPATH:$JBOSS_HOME/server/default/lib/mysql-connector-java-3.0.8-stable-bin.jar"
