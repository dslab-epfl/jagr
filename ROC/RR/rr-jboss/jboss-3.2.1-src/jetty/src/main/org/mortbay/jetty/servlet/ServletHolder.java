...
// $Id: ServletHolder.java,v 1.3 2004/04/23 00:55:23 candea Exp $
// ---------------------------------------------------------------------------
 ...
 * requested.
 *
 * @version $Id: ServletHolder.java,v 1.3 2004/04/23 00:55:23 candea Exp $
 * @author Greg Wilkins
 */
    ...
    implements Comparable
{
	...
	interceptor.addComponent(name, "servlet");
	this.name = name;
    }
    ...
    public void stop()
    {
		...
		// interceptor.removeComponent(name);
	    }
        _servlet=null;
               ...
               IOException
    {
        ...
        catch(UnavailableException e)
        {
            if (_servlets!=null && servlet!=null)
                servlet.destroy();
            servlet=null;
	    interceptor.reportFault(name, "", e);
            throw e;
        }
        finally
        {
