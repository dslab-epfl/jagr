...
public class TransitionFunction
{
    ...
    public static final RubisUserState LOGIN_USR   = new RubisUserState( 23, "LoginUser" );
    ...
    public static RubisUserState[] states = 
                              { HOME, REGISTER, REG_USER, BROWSE, BROWSE_CAT, SEARCH_CAT, BROWSE_REG,
