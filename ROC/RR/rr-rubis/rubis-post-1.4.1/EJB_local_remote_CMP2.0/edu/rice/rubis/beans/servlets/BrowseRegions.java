...
public class BrowseRegions extends HttpServlet
{
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    sp = new ServletPrinter(request, response, "BrowseRegions");
    ...
    String jndiName  = "SB_BrowseRegionsHome";
    Object jndiValue = null;

    try
    {
	jndiValue = initialContext.lookup(jndiName);
	home = (SB_BrowseRegionsHome)PortableRemoteObject.narrow(jndiValue, SB_BrowseRegionsHome.class);
