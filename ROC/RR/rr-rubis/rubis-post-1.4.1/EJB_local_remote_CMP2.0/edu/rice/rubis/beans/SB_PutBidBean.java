...
public class SB_PutBidBean implements SessionBean 
{
   ...
   * @since 1.1
   */
  public Object[] getBiddingForm(Integer itemId, String username, 
			       String password)
  ...
  public String getBiddingForm(Integer itemId, int userId) throws RemoteException {
      ...
      SB_ViewItem viewItem;
      try {
	  itemHome = (SB_ViewItemHome)PortableRemoteObject.narrow(initialContext.lookup("java:comp/env/ejb/SB_ViewItem"),SB_ViewItemHome.class);
	  viewItem = itemHome.create();
      } catch (Exception e) {
	  throw new RemoteException("Cannot lookup SB_ViewItem: " +e+"<br>");
      } try {
