...
public class URLGeneratorPHP extends URLGenerator
{
  ...
  /**
   * Returns the name of the Login User script.
   *
   * @return Login User script name
   */
  public String LoginUserScript()
  {
      return "LOGIN_NOT_IMPLEMENTED_FOR_PHP";
  }
  /**
   * Returns the name of the Logout script.
   *
   * @return Logout script name
   */
  public String LogoutScript()
  {
      return "LOGOUT_NOT_IMPLEMENTED_FOR_PHP";
  }
