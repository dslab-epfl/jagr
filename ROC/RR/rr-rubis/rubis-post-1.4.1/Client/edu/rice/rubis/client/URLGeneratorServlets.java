...
public class URLGeneratorServlets extends URLGenerator
{
  ...
  /**
   * Returns the name of the Login User servlet.
   *
   * @return Login User script name
   */
  public String LoginUserScript()
  {
      return "edu.rice.rubis.beans.servlets.Login";
  }
  /**
   * Returns the name of the Logout servlet.
   *
   * @return Logout script name
   */
  public String LogoutScript()
  {
      return "edu.rice.rubis.beans.servlets.Logout";
  }
