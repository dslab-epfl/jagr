...
public class CategoryBean implements EntityBean 
{
  ...
  {
    return "<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.SearchItemsByCategory?category="+id+
  ...
  {
    return "<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.SearchItemsByRegion?category="+id+
  ...
  {
    return "<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.SellItemForm?category="+id+"&user="+userId+"\">"+name+"</a><br>\n";
  }
}
