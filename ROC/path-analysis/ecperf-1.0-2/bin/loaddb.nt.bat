...
set APPSSERVER=%CONFIG_DIR%\JBoss
...
set JDBC_CLASSPATH=C:\app\jdbc\classes12.zip
...
%JAVA_HOME%\jre\bin\java -Decperf.home=%ECPERF_HOME% %LOAD_PKG%.LoadRules discount %ECPERF_HOME%\schema\discount.rules
