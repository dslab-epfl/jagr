...
<TR>
	...
	<TD colspan=2>
		...
		<center>
		<br><b><font size=+4>Change Order Status</font></b></center>
		...
		<BR>
		<% 
			processList.addRemovedItemsToCustomerList();
			orderSes.changeOrder(processList.getCustomerList(), processList.getOrderNumber());
		%>
		<font size=+3> Order change was successful. 
		</font>
