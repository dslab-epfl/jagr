 ...
 *
 * $Id: OrderEntry.java,v 1.1.1.1 2002/11/16 05:35:25 emrek Exp $
 *
 */
	...
	private void doNewOrder() {
		...
		if (cid > custDBSize) {
			...
			Address adr = new Address(
				r.make_a_string(10,20),	//street1
				r.make_a_string(10,20),	//street2
				r.make_a_string(10,20),	//city
				r.make_a_string(2,2),		//state
				r.make_a_string(3,10),	//country
				zip,
				r.make_n_string(12,16));	//phone
			...
			CustomerInfo info = new CustomerInfo(
				r.make_a_string(8,16),	//first
				r.make_a_string(8,16),	//last
				adr,
				r.make_a_string(10,25),	//contact
                                credit, 
                                creditLimit,
                                balance,
                                YtdPayment
