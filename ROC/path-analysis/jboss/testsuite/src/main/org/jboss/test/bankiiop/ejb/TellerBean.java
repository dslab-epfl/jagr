      ...
      throws BankException
   {
      try
      {
         BankHome bankHome = (BankHome)PortableRemoteObject.narrow(
                               new InitialContext().lookup(BankHome.JNDI_NAME),
                               BankHome.class);
      ...
      throws BankException
   {
      try
      {
         ...
         CustomerHome home = (CustomerHome)PortableRemoteObject.narrow(
                           new InitialContext().lookup(CustomerHome.JNDI_NAME),
                           CustomerHome.class);
...
/*
 *   $Id: TellerBean.java,v 1.1.1.1 2002/11/16 03:16:42 mikechen Exp $
