 ...
 *
 * <p><b>Revisions:</b><br>
 * <p><b>27.08.2002 - Sacha Labourey:</b>
 * <ul>
...
public interface HAPartition
{
    ...
    * does not need to implement any specific interface: the call is handled dynamically through reflection.
    ...
    * @param excludeSelf indicates if the RPC must also be made on the current node of the partition or only on remote nodes
    * @throws Exception Throws if a communication exception occurs
    * @return an array of answers from remote nodes
    */   

   public ArrayList callMethodOnCluster(String serviceName, String methodName, Object[] args, boolean excludeSelf) throws Exception;
   /**
    * Invoke a asynchronous RPC call on all nodes of the partition/cluster. The call will return immediately and will not wait
    ...
    * @throws Exception Throws if a communication exception occurs
    */   
   public void callAsynchMethodOnCluster (String serviceName, String methodName, Object[] args, boolean excludeSelf) throws Exception;
