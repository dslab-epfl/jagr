...
// $Id: JmxUnitTestCase.java,v 1.1.1.1 2002/11/16 03:16:50 mikechen Exp $
...
public class JmxUnitTestCase extends AxisTestCase {
   ...
   public void testBasic() throws Exception {
        ...
        handler.invoke("RemoteAdaptor","isRegistered",new Object[] {new String[] {"javax.management.ObjectName"}, 
