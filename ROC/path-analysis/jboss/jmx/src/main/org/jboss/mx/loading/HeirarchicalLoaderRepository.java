...
/**
 * A simple extension of UnifiedLoaderRepository that adds the notion of a
 ...
 */
public class HeirarchicalLoaderRepository extends UnifiedLoaderRepository
{
   // Attributes ----------------------------------------------------
   private static final Logger log = Logger.getLogger(HeirarchicalLoaderRepository.class);
   ...
   public HeirarchicalLoaderRepository(MBeanServer server)
      throws AttributeNotFoundException, InstanceNotFoundException,
      MBeanException, ReflectionException
   {
      this(server, DEFAULT_LOADER_NAME);
   }
   public HeirarchicalLoaderRepository(MBeanServer server, ObjectName parentName)
      throws AttributeNotFoundException, InstanceNotFoundException,
      MBeanException, ReflectionException
   {
