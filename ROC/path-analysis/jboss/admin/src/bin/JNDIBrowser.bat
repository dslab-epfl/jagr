...
REM ----------------------------------------------------------------
REM 
REM    Batch file for running the JBoss JNDI Browser.
REM
REM    Author:    Juha Lindfors
REM    Revision:  $Id: JNDIBrowser.bat,v 1.1.1.1 2002/11/16 03:16:41 mikechen Exp $
REM
REM ----------------------------------------------------------------
...
REM ----------------------------------------------------------------
:Run
java -cp "%CP%" org.jboss.admin.jndi.Main %1 %2 %3 %4 %5 %6 %7
