...
public class LogInterceptor extends AbstractInterceptor
{
      ...
      throws Exception
   {
      ...
      if (callLogging)
      {
       ...
       //// PATH-ANALYSIS MIKECHEN: BEGIN ////
       //// 1. this is right before the invokation of the EJB.
       ////    might need to pull out the request ID from the RMI call.
       ////    
      //String callee = ejbName; //getContainer().getBeanClass().getName();
      //String calleeMethod = methodName;
       //System.err.println("LogIntercepter(invokeHome): REQUEST_ID (THREAD_LOCAL) = " + tracing.ThreadLocalRequestMarker.getRequestId() + ", " + callee + "." + calleeMethod + "()");
       //// PATH-ANALYSIS MIKECHEN: END   ////
      ...
      throws Exception
   {
      ...
      //String callee = ejbName; //getContainer().getBeanClass().getName();
      //String calleeMethod = methodName;
       //System.err.println("LogIntercepter(invoke): REQUEST_ID (THREAD_LOCAL) = " + tracing.ThreadLocalRequestMarker.getRequestId() + ", " + callee + "." + calleeMethod + "()");
       //// PATH-ANALYSIS MIKECHEN: END   ////
