...
public class RMISSLServerSocketFactory implements RMIServerSocketFactory
{
   ...
   /** Creates new RMISSLServerSocketFactory initialized to the 
    DomainServerSocketFactory.getDefault value. The setSecurityDomain method
    must be invoked to establish the correct non-default value.
    */
