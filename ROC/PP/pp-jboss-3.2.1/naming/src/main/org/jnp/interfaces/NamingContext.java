   ...
   implements Context, java.io.Serializable
{
   ...
   throws NamingException
   {
       ...
       /// BEGIN ROC PINPOINT EMK
       PP_reportMethodCall( "rename", newName.toString(), true );
      ...
      // BEGIN ROC PINPOINT EMK
	   ...
	   PP_reportMethodCall( "rename", newName.toString(), false );
       }
       /// END ROC PINPOINT EMK
   }
   ...
   throws NamingException
   {
       ...
       /// BEGIN ROC PINPOINT EMK
       PP_reportMethodCall( "createSubcontext", name.toString(), true );
      ...
      // BEGIN ROC PINPOINT EMK
	   ...
	   PP_reportMethodCall( "createSubcontext", name.toString(), false );
       }
       /// END ROC PINPOINT EMK
   }
      ...
      throws NamingException
   {
       ...
       /// BEGIN ROC PINPOINT EMK
       PP_reportMethodCall( "lookupLink", name.toString(), true );
      ...
      // BEGIN ROC PINPOINT EMK
	   ...
	   PP_reportMethodCall( "lookupLink", name.toString(), false );
       }
       /// END ROC PINPOINT EMK
   }
      ...
      throws InvalidNameException
   {
    ...
    /// BEGIN ROC PINPOINT EMK
    private void PP_reportMethodCall( String method, String arg, boolean isBegin ) {
	if( roc.config.ROCConfig.ENABLE_PINPOINT &&
	    roc.config.ROCConfig.ENABLE_PINPOINT_TRACING_JNDI ) {
	    roc.pinpoint.tracing.TracingHelper.ReportMethod( "org.jnp.server.NamingContext",
							     roc.pinpoint.tracing.TracingHelper.TYPE_JNDI, "org.jnp.server.NamingContext",
							     method, arg, isBegin );
	}
    }

    private void PP_reportError( String method, Throwable t ) {
	if( roc.config.ROCConfig.ENABLE_PINPOINT &&
	    roc.config.ROCConfig.ENABLE_PINPOINT_TRACING_JNDI ) {
	    roc.pinpoint.tracing.TracingHelper.ReportException( "org.jnp.server.NamingContext",
