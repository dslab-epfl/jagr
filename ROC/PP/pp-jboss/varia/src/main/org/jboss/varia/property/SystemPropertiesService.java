   ...
   implements SystemPropertiesServiceMBean
{
   ...
   /** Set system properties by merging the given properties object. Each
    * property in props is checked for property references of the form
    * ${pname} that are replaced with the current System.getProperty(pname)
    * value.
    *
    * @jmx:managed-attribute
    *
