   ...
   implements BaseConnectionManager2MBean, ConnectionCacheListener
{
   ...
   protected abstract class BaseConnectionEventListener implements ConnectionListener
   {
      ...
      /**
       * The <code>unregisterConnections</code> method unregisters all
       * the connection handles for this managed connection.  I'm a
       * little worried that synchronizing this method while calling
       * out to the ccm may introduce a deadlock.  Looking at the code
       * involved in the ccm, I do not see any problem.
       *
       */
