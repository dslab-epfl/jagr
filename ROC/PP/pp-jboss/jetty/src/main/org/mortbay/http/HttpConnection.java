...
// $Id: HttpConnection.java,v 1.7 2003/08/20 14:34:37 emrek Exp $
// ========================================================================
 ...
 * @see HttpListener
 * @see HttpServer
 * @version $Id: HttpConnection.java,v 1.7 2003/08/20 14:34:37 emrek Exp $
    ...
    implements OutputObserver
{
	...
	//// ROC PINPOINT MIKECHEN EMK BEGIN ////   21 LINES
	...
	if( ROCConfig.ENABLE_PINPOINT &&
	    ...
	    roc.pinpoint.tracing.RequestInfo PP_reqInfo = null;

	    /*
	    if( _request.getField( "X-ROC-REQUESTID" ) != null ) {
		String requestid = _request.getField( "X-ROC-REQUESTID" );
		String requestctr = _request.getField( "X-ROC-REQUESTCOUNTER" );
		PP_reqInfo = new roc.pinpoint.tracing.RequestInfo();
		PP_reqInfo.setRequestId( requestid );
		try {
		    PP_reqInfo.setSeqNum( Integer.parseInt( requestctr ));
		}
	...
	//// ROC PINPOINT MIKECHEN EMK END   ////
	    ...
	    {
		roc.pinpoint.tracing.RequestInfo PP_reqInfo = roc.pinpoint.tracing.ThreadedRequestTracer.getRequestInfo();
		String requestid = PP_reqInfo.getRequestId();
		String requestctr = Integer.toString( PP_reqInfo.getSeqNum() );
		//_response.setField( "X-ROC-REQUESTD", requestid );
		//_response.setField( "X-ROC-REQUESTCOUNTER", requestctr );
	    }
	    ...
	    //// ROC PINPOINT MIKECHEN EMK BEGIN ////  25 LINES
