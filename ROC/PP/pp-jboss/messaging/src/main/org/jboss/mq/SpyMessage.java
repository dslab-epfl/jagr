   ...
   implements Serializable, Message, Comparable, Externalizable
{
   ...
   public void setBooleanProperty(String name, boolean value) throws JMSException {
      ...
      header.jmsProperties.put(name, new Boolean(value));
   }
   ...
   public void setByteProperty(String name, byte value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Byte(value));
   }
   ...
   public void setShortProperty(String name, short value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Short(value));
   }
   ...
   public void setIntProperty(String name, int value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Integer(value));
   }
   ...
   public void setLongProperty(String name, long value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Long(value));
   }
   ...
   public void setFloatProperty(String name, float value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Float(value));
   }
   ...
   public void setDoubleProperty(String name, double value) throws JMSException {
      ...
      if (!header.jmsPropertiesReadWrite)
         throw new MessageNotWriteableException("Properties are read-only");
      header.jmsProperties.put(name, new Double(value));
   }
