 ...
 *  </ol>
 *  <p><b>2002/05/25: Dain Sundstrom</b>
 *  <ol>
 *   <li>Removed FinderResults code which was never executed anyway.
 *  </ol>
 */
   ...
   implements ContainerInvoker
{
   ...
   public void create() throws Exception
   {
      ...
      objectName = jmxName.hashCode();
      Registry.bind(new Integer(objectName), jmxName);
      log.debug("Bound jmxName="+jmxName+", hash="+objectName+"into Registry");
      ...
      throws Exception
   {
	 ...
	 if( ! Interceptor.class.isAssignableFrom( clazz ) ) {
	     System.err.println( "Interceptor.class = " + Interceptor.class.getName() + "[" + Interceptor.class.hashCode() + "]" );
	     System.err.println( "other plugin class = " + clazz.getName() + "[" + clazz.hashCode() + "]" );
	     Class superclazz = clazz.getSuperclass();
	     while( superclazz != null ) {
		 System.err.println( "plugin superclass = " + superclazz.getName() + "[" + superclazz.hashCode() + "]" );
		 superclazz = superclazz.getSuperclass();
	     }
	     throw new RuntimeException( "ACK! trying to load interceptor " + className + " but it's not an Interceptor!!!" );
	 }
         classes.add(clazz);
      }
   }
   ...
   /** 
    * Create a Collection which contains an EJBObject proxy for each id 
    * in the suplied collection.
    * @param ids the identifiers for which EJB proxies will be created
    */
   public Collection getEntityCollection(Collection ids)
   {
      ...
      for(Iterator iter = ids.iterator(); iter.hasNext(); )
      {
         ...
         context.setValue(
               org.jboss.proxy.ejb.GenericEJBInterceptor.JNDI_NAME, jndiName);
         context.setInvoker(beanInvoker);
