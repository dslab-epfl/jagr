...
public class ConfigurationMetaData extends MetaData
{
   ...
   public Object clone()
   {
      ConfigurationMetaData result = (ConfigurationMetaData) super.clone();
      if (this.containerInvokerConf != null)
         result.containerInvokerConf = (Element) this.containerInvokerConf.cloneNode(true);
      if (this.containerPoolConf != null)
         result.containerPoolConf = (Element) this.containerPoolConf.cloneNode(true);
      if (this.containerCacheConf != null)
         result.containerCacheConf = (Element) this.containerCacheConf.cloneNode(true);
      if (this.containerInterceptorsConf != null)
         result.containerInterceptorsConf = (Element) this.containerInterceptorsConf.cloneNode(true);
      if (this.clientInterceptors != null)
         result.clientInterceptors = (Element) this.clientInterceptors.cloneNode(true);
      if (this.clientInterceptorConfs != null)
         result.clientInterceptorConfs = (HashMap) this.clientInterceptorConfs.clone();
      return result;
   }
