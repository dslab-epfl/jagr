...
<%@page contentType="text/html"
   import="java.beans.Beans,java.io.*,java.security.*,javax.naming.*,org.jboss.test.web.util.*"
%>
<%!
...
<h3>Access WEB-INF/lib/util.jar!org/jboss/test/web/util/ReportBean.class as JavaBean</h3>
<pre>
<%
