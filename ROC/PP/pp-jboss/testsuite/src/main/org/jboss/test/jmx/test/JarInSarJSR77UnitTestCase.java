...
public class JarInSarJSR77UnitTestCase extends JBossTestCase 
{
   ...
   public void testFakeParentCreatedAndRemoved() throws Exception
   {
      ...
      ObjectName fakeApp = new ObjectName("jboss.management.single:J2EEServer=Single,name=jarinsar.sar,j2eeType=J2EEApplication");
      ObjectName ejbModule = new ObjectName("jboss.management.single:name=jarinsar.jar,J2EEServer=Single,J2EEApplication=jarinsar.sar,j2eeType=EJBModule");
      ObjectName bean = new ObjectName("jboss.management.single:J2EEServer=Single,name=TestDataSource,J2EEApplication=jarinsar.sar,EJBModule=jarinsar.jar,j2eeType=StatelessSessionBean");
