...
public class CircularLoadTests
{
   ...
   public void testUCLOwner() throws Exception
   {
      ...
      LoadThread t0 = new LoadThread("org.jboss.test.classloader.circularity.supportx.Class2", ucl0, "T0");
      t0.start();
      // Join the thread
      t0.join(5000);
      ...
      LoadThread t1 = new LoadThread("org.jboss.test.classloader.circularity.support.Class2", ucl1, "T1");
      t1.start();
      // Join the thread
      t1.join(5000);
   ...
   public void testMissingSuperClass() throws Exception
   {
      ...
      LoadThread t0 = new LoadThread("org.jboss.test.classloader.circularity.support.Derived", ucl0, "T0");
      t0.start();
      // Join the thread
      t0.join(5000);
      if( t0.loadedClass != null || t0.loadError == null )
   ...
   public void testLoading() throws Exception
   {
      ...
      LoadThread t0 = new LoadThread("org.jboss.test.classloader.circularity.support.Class2", ucl0, "T0");
      LoadThread t1 = new LoadThread("org.jboss.test.classloader.circularity.support.Class0", ucl1, "T1");
      LoadThread t2 = new LoadThread("org.jboss.test.classloader.circularity.support.Class1", ucl2, "T2");
      t0.start();
      t1.start();
      t2.start();
      // Join the threads
