       ...
       extends JBossTestCase
{
   ...
   public void testDependsElement() throws Exception
   {
      ...
      ObjectName classLoaderObjectName = new ObjectName("jboss.system:service=ServiceClassLoader");
      try
      {
         //check they aren't there already
   ...
   */
   ...
   //The Sun RI jmx registers this invalid mbean!!
   {
      ...
      catch(Exception e)
      {
         ...
         assertTrue("nullinfo mbean is registered!", !isRegistered);
      }
      finally
      {
         try
   ...
   public void testDDEntityRefs() throws Exception
   {
      ...
      assertTrue("test mbean not registered after deploy", checkState(name, RUNNING));
      undeploy(testUrl);
   }
