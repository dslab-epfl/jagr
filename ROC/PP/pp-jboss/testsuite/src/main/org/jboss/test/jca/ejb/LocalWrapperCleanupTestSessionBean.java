   ...
   implements SessionBean  
{
    ...
    * @ejb:transaction type="NotSupported"
    */
   public void testAutoCommitOffInUserTx() throws EJBException
   {
      try 
      {
         DataSource ds = (DataSource)new InitialContext().lookup("java:/DefaultDS");
    ...
    * @ejb:transaction type="NotSupported"
    */
   public void testAutoCommitOffInUserTx2() throws EJBException
   {
      try 
      {
         createTable();
    ...
    * @ejb:transaction type="NotSupported"
    */
   public void createTable()throws EJBException
   {
      try 
      {
         DataSource ds = (DataSource)new InitialContext().lookup("java:/DefaultDS");
    ...
    * @ejb:transaction type="NotSupported"
    */
   public void insertAndCheckAutoCommit() throws EJBException
   {
      try 
      {
         DataSource ds = (DataSource)new InitialContext().lookup("java:/DefaultDS");
    ...
    * @ejb:transaction type="NotSupported"
    */
   public void checkRowAndDropTable() throws EJBException
   {
      try 
      {
         DataSource ds = (DataSource)new InitialContext().lookup("java:/DefaultDS");
