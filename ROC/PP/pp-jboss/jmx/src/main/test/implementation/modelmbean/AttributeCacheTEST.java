 ...
 */
public class AttributeCacheTEST extends TestCase
{
   ...
   public void testImplicitDisabledAttributeCaching() throws Exception
   {
      ...
      XMBean mmb = new XMBean(resource, "file:./src/main/test/implementation/modelmbean/support/xml/TrivialManagementInterface.xml");
   ...
   public void testExplicitDisabledAttributeCaching() throws Exception
   {
      ...
      MBeanServer server = MBeanServerFactory.createMBeanServer();
      Test resource = new Test();
      XMBean mmb = new XMBean(resource, "file:./src/main/test/implementation/modelmbean/support/xml/TrivialManagementInterface2.xml");
   ...
   public void testNeverStaleAttributeCaching() throws Exception
   {
      ...
      MBeanServer server = MBeanServerFactory.createMBeanServer();
      Test resource = new Test();
      XMBean mmb = new XMBean(resource, "file:./src/main/test/implementation/modelmbean/support/xml/TrivialManagementInterface3.xml");
   ...
   public void testCachedAttribute() throws Exception
   {
      ...
      MBeanServer server = MBeanServerFactory.createMBeanServer();
      Test resource = new Test();
      XMBean mmb = new XMBean(resource, "file:./src/main/test/implementation/modelmbean/support/xml/TrivialManagementInterface4.xml");
   ...
   public void testCachedAttribute2() throws Exception
   {
      MBeanServer server = MBeanServerFactory.createMBeanServer();
      Test resource = new Test();
      XMBean mmb = new XMBean(resource, "file:./src/main/test/implementation/modelmbean/support/xml/TrivialManagementInterface5.xml");
