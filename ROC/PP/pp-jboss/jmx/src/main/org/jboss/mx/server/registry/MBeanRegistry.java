   ...
   extends ServerConstants
{
    ...
    *
    * Pass {@link ServerConstants#JMI_DOMAIN JMI_DOMAIN} in the magic token to 
    * get access to the reserved domain
    *
    ...
    *            or a null object
    */
   ObjectInstance registerMBean(Object object, ObjectName name, ClassLoader cl,
                                Object magicToken)
