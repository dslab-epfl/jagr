   ...
   implements HARMIProxy, java.lang.reflect.InvocationHandler, java.io.Serializable
{
   ...
   public HARMIClient(ArrayList targets, long initViewId, LoadBalancePolicy policy, String key)
   {
      this.targets = targets;
      this.currentViewId = initViewId;
   ...
   private void readObject (java.io.ObjectInputStream stream) throws java.io.IOException, ClassNotFoundException
   {
      ...
      this.currentViewId = stream.readLong ();
   ...
   private void writeObject (java.io.ObjectOutputStream stream) throws java.io.IOException
   {
      ...
      stream.writeLong(this.currentViewId);
