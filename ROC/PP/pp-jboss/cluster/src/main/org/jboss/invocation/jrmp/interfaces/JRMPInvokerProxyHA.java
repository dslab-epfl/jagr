   ...
   implements InvokerProxyHA, Externalizable
{
   ...
   public JRMPInvokerProxyHA(ArrayList targets, long viewId, LoadBalancePolicy policy)
   {
   ...
   public void updateClusterInfo (ArrayList newTargets, long viewId)
   {
         ...
         while (target != null)
         {
	       ...
	       // ROC PINPOINT EMK END
               ...
               if (rsp.newReplicants != null)
               {
                  ...
                  // System.out.println (this.getClass().getName() + " NEW SET OF PROXIES: " + (rsp.newReplicants==null? 0 : rsp.newReplicants.size () ));
                  // System.out.println ("old id: " + currentViewId + ", new Id: " + rsp.currentViewId);
   ...
   */
   ...
   { 
      ...
      out.writeLong (this.currentViewId);
   }
   ...
   */
   ...
   throws IOException, ClassNotFoundException
   {
      ...
      this.currentViewId = in.readLong ();
   }
