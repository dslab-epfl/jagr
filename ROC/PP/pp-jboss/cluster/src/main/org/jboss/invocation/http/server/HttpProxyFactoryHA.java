   ...
   implements HttpProxyFactoryHAMBean
{
   ...
   protected Invoker createInvoker() throws Exception
   {
      ...
      */
      ...
      invokerTarget = new HATarget(partition, wrappedJmxInvokerName.toString(), invokerStub);
      ...
      ArrayList targets = invokerTarget.getReplicants();
      Invoker delegateInvoker = new HttpInvokerProxyHA(targets, invokerTarget.getCurrentViewId (), policy);
