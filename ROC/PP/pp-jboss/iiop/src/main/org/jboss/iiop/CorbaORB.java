...
public class CorbaORB
{
    ...
    * the client side: the handle impl (org.jboss.ejb.plugins.iiop.HandleImpl),
    * the home handle impl (org.jboss.ejb.plugins.iiop.HomeHandleImpl),
    * and the home factory (org.jboss.ejb.plugins.iiop.HomeFactory).
