...
public class ServiceConfigurator
{
   ...
   private ObjectName serviceBindingMgr;
                              ...
                              final ServiceCreator serviceCreator)
   {
      ...
      try
      {
         ...
         serviceBindingMgr = new ObjectName("jboss.system:service=ServiceBindingManager");
      }
      catch (MalformedObjectNameException e)
      {
         log.warn("Failed to created serviceBindingMgr name", e);
      }
   }
    ...
    */
   protected void configure(ObjectName objectName, ObjectName loaderName, Element mbeanElement, List mbeans)
      throws Exception
   {
   ...
   private ObjectName processDependency(ObjectName container, ObjectName loaderName, Element element, List mbeans) 
      throws Exception
   {
