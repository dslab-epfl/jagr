   ...
   */
   ...
   public void createClassLoaders() throws Exception
   {
      ...
      */
      ...
      repositoryClassName = current.repositoryClassName;
      if( parent == null )
      {
         // Make sure the specified LoaderRepository exists.
         LoaderRepositoryFactory.ensureLoaderRepository(server, repositoryClassName, repositoryName);
    ...
    * @throws Exception
    */
   public void setRepositoryInfo(String repositoryClassName, ObjectName repositoryName)
       throws Exception
   {
      if( parent != null )
         throw new IllegalStateException("Only the root deployment can set the loader repository");
