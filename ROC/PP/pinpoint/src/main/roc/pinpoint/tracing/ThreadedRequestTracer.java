...
/**
 * This class is used for tracking requests when there is a one-to-one
 * correspondence between a request and a thread.
 *
 *
 * @author emrek@cs.stanford.edu and <A
 * HREF="http://www.cs.berkeley.edu/~mikechen/">Mike Chen</A> (<A
 * HREF="mailto:mikechen@cs.berkeley.edu">
