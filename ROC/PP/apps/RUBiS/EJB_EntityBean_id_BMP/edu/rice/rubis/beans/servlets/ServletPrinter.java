...
public class ServletPrinter
{
  ...
  void printBid(Bid bid)
  {
    try
    {
      out.println("<a href=\"../ejb_rubis_web/servlet/BrowseBid\">"+
  ...
  void printRegion(Region region)
  {
    try
    {
      ...
      out.println("<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.BrowseCategories?region="+URLEncoder.encode(name)+"\">"+name+"</a><br>\n");
// TAKEN OUT: MAURICIO  out.println("<a href=\"/servlet/edu.rice.rubis.beans.servlets.BrowseCategories?region="+URLEncoder.encode(name)+"\">"+name+"</a><br>\n");
  ...
  void printItemDescription(Item item, int userId, Context initialContext)
  {
    try
    {
      ...
      out.println("<TR><TD>Quantity<TD><b><BIG>"+qty+"</BIG></b>\n"+
                  ...
                  "<TR><TD># of bids<TD><b><BIG>"+nbOfBids+"</BIG></b> (<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewBidHistory?itemId="+itemId+"\">bid history</a>)\n"+
                  "<TR><TD>Seller<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewUserInfo?userId="+sellerId+"\">"+item.getSellerNickname()+"</a> (<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.PutCommentAuth?to="+sellerId+"&itemId="+itemId+"\">Leave a comment on this user</a>)\n"+
                  "<TR><TD>Started<TD>"+item.getStartDate()+"\n"+
                  "<TR><TD>Ends<TD>"+item.getEndDate()+"\n"+
                  "</TABLE>");
      // Can the user buy this item now ?
      if (buyNow > 0)
        out.println("<p><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.BuyNowAuth?itemId="+itemId+"\">"+
                    "<IMG SRC=\"/EJB_HTML/buy_it_now.jpg\" height=22 width=150></a>"+
                    "  <BIG><b>You can buy this item right now for only $"+buyNow+"</b></BIG><br><p>\n");

      if (userId<=0)
      {
        out.println("<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.PutBidAuth?itemId="+itemId+"\"><IMG SRC=\"/EJB_HTML/bid_now.jpg\" height=22 width=90> on this item</a>\n");
      }
      ...
      if (userId>0)
      {
        ...
        printHTML("<form action=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.StoreBid\" method=POST>\n"+
