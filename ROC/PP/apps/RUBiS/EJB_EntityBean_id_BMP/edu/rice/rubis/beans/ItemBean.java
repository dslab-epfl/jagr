...
public class ItemBean implements EntityBean 
{
  ...
  {
    return "<TR><TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewItem?itemId="+id+"\">"+name+
      "<TD>"+maxBid+
      "<TD>"+nbOfBids+
      "<TD>"+endDate+
      "<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.PutBidAuth?itemId="+id+"\"><IMG SRC=\"/EJB_HTML/bid_now.jpg\" height=22 width=90></a>\n";
  }
  ...
  {
    return "<TR><TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewItem?itemId="+id+"\">"+name+"</a>\n"+
      "<TD>"+qty+"\n"+"<TD>"+buyNow+"\n"+
      "<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewUserInfo?userId="+sellerId+"\">"+getSellerNickname()+"</a>\n";
  }
  ...
  public String printItemUserHasBidOn(float bidMaxBid) throws RemoteException
  {
    return "<TR><TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewItem?itemId="+id+"\">"+name+
      ...
      "<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewUserInfo?userId="+sellerId+"\">"+getSellerNickname()+
      "<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.PutBid?itemId="+id;
  }
  ...
  public String printItemDescriptionToBuyNow(int userId) throws RemoteException
  {
    String result = "<TABLE>\n"+"<TR><TD>Quantity<TD><b><BIG>"+quantity+"</BIG></b>\n"+
      "<TR><TD>Seller<TD><a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.ViewUserInfo?userId="+sellerId+"\">"+
      getSellerNickname()+"</a> (<a href=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.PutCommentAuth?to="+sellerId+"&itemId="+id+"\">Leave a comment on this user</a>)\n"+
      ...
      "</TABLE><p>\n"+
      "<form action=\"/ejb_rubis_web/servlet/edu.rice.rubis.beans.servlets.StoreBuyNow\" method=POST>\n"+
