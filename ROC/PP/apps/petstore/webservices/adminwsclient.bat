...
set CLASSPATH=AdminApp.jar
set CLASSPATH=%J2EE_HOME%/lib/j2ee.jar;%J2EE_HOME%\lib\system\jwsdp-common.jar;%CLASSPATH%
set CLASSPATH=%JAVA_HOME%/lib/tools.jar;%CLASSPATH%

%JAVA_HOME%\bin\java -classpath "%CLASSPATH%" com.sun.j2ee.blueprints.admin.client.PetStoreAdminClient com.sun.j2ee.blueprints.admin.client.WebServicePetStoreProxy %SERVER% %PORT% /admin/webservice/AdminService
goto END

:USAGE
echo "Usage: wsclient.bat <j2ee-server-host-name> <j2ee-server-port>"
goto END
