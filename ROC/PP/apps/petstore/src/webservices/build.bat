...
%JAVA_HOME%\bin\java -classpath "%ANT_CLASSPATH%" -Dxrpcc=%JWSDP_HOME%/bin/xrpcc.bat -Dant.home=%ANT_HOME% -Dj2ee.home=%J2EE_HOME% -Dj2ee-script-suffix=.bat -Djwsdp-script-suffix=.bat org.apache.tools.ant.Main %1 %2 %3 %4
