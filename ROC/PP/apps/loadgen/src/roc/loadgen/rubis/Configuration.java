...
public class Configuration
{
    ...
    public static int    minUserId; // the smallest user ID we can use
    public static int    maxUserId; // the greatest user ID we can use
    public static int    numUsersInDB; // number of users in the database
	...
	try
	{
	    ...
	    minUserId = Integer.parseInt( prop.getProperty( "min_user_id" ));
	    maxUserId = Integer.parseInt( prop.getProperty( "max_user_id" ));
    ...
    {
	return System.getProperty("env.confdir") + "/" + name;
    }
