...
private final int jjMoveStringLiteralDfa11_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      case 100:
         if ((active0 & 0x40000000000000L) != 0L)
            return jjStartNfaWithStates_0(11, 54, 32);
         break;
      default :
         break;
   }
...
static final long[] jjtoToken = {
   0xffffffffffffc001L, 0x1fffffffffff9d1L, 
};
...
public RuleParserTokenManager(ASCII_UCodeESC_CharStream stream)
{
   if (ASCII_UCodeESC_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public RuleParserTokenManager(ASCII_UCodeESC_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
