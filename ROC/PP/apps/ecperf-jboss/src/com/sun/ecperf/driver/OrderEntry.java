 ...
 *
 * $Id: OrderEntry.java,v 1.1 2004/02/19 14:45:06 emrek Exp $
 *
 */
...
public class OrderEntry extends Thread {
	...
	public void run() {
		...
		Debug.println( "...about to getReady()" );
		getReady();		// Perform inits
		Debug.println( ident + " done with getReady()" );
	...
	private void getReady() {
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 6");
		stats = new OrdersStats(numThreads, resultsDir, txRate);
		System.out.println( "OrdersAgent("+name+";"+id+"): point 7");
		...
		****/
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 8");
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 9");

		// compute our mean arrival rate in msecs
		timePerTx = (numThreads *1000)/ txRatePerAgent;
		try {
		System.out.println( "OrdersAgent("+name+";"+id+"): point 10");
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 11");
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 12");
			orders = orderSesHome.create();
		System.out.println( "OrdersAgent("+name+";"+id+"): point 13");
			Debug.println( "created orderSesHome" );
		System.out.println( "OrdersAgent("+name+";"+id+"): point 14");
		...
		System.out.println( "OrdersAgent("+name+";"+id+"): point 15");
			customerSession = customerHome.create();
		System.out.println( "OrdersAgent("+name+";"+id+"): point 16");
			Debug.println( "created customerHome" );
			cartSesHome = 
				(CartSesHome) PortableRemoteObject.narrow
				(ctx.lookup(cartHome), CartSesHome.class);

		System.out.println( "OrdersAgent("+name+";"+id+"): point 17");
			Debug.println( "created cartSesHome" );
			
		} catch (NamingException e) {
		System.out.println( "OrdersAgent("+name+";"+id+"): point 18");
			errp.println(ident + "Failure looking up home " + e);
			start = false;
		} catch (Exception ex) {
		System.out.println( "OrdersAgent("+name+";"+id+"): point 19");
			errp.println(ident + "Failure in creating beans " + ex);
			ex.printStackTrace();
			start = false;
		}
		System.out.println( "OrdersAgent("+name+";"+id+"): point 20");
	}
