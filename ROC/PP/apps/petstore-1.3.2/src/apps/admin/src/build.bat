...
java -classpath "%ANT_CLASSPATH%" -Dant.home=%ANT_HOME% -Dj2ee.home=%J2EE_HOME% -Dj2ee-script-suffix=.bat -Destore.javadoc.classpath="%J2EE_HOME%/lib/j2ee.jar;../build/lib/classes" org.apache.tools.ant.Main %1 %2 %3 %4
