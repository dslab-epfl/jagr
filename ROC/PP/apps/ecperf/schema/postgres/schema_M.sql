...
CREATE  INDEX M_parts_idx ON M_parts (p_id);
...
CREATE  INDEX M_bom_idx ON M_bom (b_assembly_id, b_comp_id, b_line_no);
...
CREATE  INDEX M_wo_idx ON M_workorder (wo_number);
...
CREATE  INDEX M_inv_idx ON M_inventory (in_p_id);
