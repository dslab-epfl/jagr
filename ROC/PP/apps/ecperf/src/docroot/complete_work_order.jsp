...
<TR>
	...
	<TD colspan=2>
		...
		<center>
		<br><b><font size=+4>Complete Work Order </font></b></center>
		...
		<%
			...
			if (order_id != null) {
				if (workOrderSes.completeWorkOrder(order_id) ) {
		%>
					&nbsp&nbsp <font size=+3>  Completed order <%= order_id.intValue() %></font>
					<BR><BR><BR><BR><BR><BR><BR><BR><BR>
		<%
				} else {
		%>
					<font size=+3>  Work order <%= order_id.intValue() %> can't be completed. </font>
					<BR> <BR>
		<%
				}
