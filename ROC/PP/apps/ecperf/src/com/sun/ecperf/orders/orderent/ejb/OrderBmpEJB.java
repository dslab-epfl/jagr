 ...
 *
 * $Id: OrderBmpEJB.java,v 1.2 2003/03/22 04:55:01 emrek Exp $
 *
 *
 */
...
//                     AND o_ship_date = ? ");
            ...
            statement.setInt(2, customerIdCache);
            statement.setInt(3, orderLineCountCache);
            statement.setDouble(4, discountCache);
            statement.setDouble(5, totalCache);
            statement.setInt(6, orderStatusCache);
            statement.setTimestamp(7, entryDateCache);
